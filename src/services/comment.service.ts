...
export class CommentaireService {
  ...
  static async createComment(commentaire: Commentaire): Promise<Commentaire | null> {
    try {
  ...
  static async createReplyToComment(commentId: number, replyContent: string, userId: number): Promise<Commentaire | null> {
    try {
